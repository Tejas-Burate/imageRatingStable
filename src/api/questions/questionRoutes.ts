...
router.get("/getQuestionsCountByCategory", getQuestionsCountByCategory);
router.post("/verifyQuestionAnswer", verifyQuestionAnswer);
router.post("/getQuestionsFilters", getQuestionsFilters);
router.get("/getAllQuestionByCategoryId/:id", getAllQuestionByCategoryId);
router.post("/getFiveQuestionByCategoryId", getFiveQuestionByCategoryId);
router.post("/getNextQuestionByCategoryId", getNextQuestionByCategoryId);
router.post("/bulkUploadQuestions", upload.single("file"), bulkUploadQuestions);
