 ...
 *         description: Question not found
 */
router.post("/createQuizQuestion", questionController_1.createQuizQuestion);
...
router.post("/verifyQuizQuestionAnswer", questionController_1.verifyQuizQuestionAnswer);
router.get("/getAllQuestionByCategoryId/:id", questionController_1.getAllQuestionByCategoryId);
router.post("/getFiveByQuestionByQuizId", questionController_1.getFiveByQuestionByQuizId);
router.post("/getNextQuestionByQuizId", questionController_1.getNextQuestionByQuizId);
router.post("/getCompetitionQuestionsFilters", questionController_1.getCompetitionQuestionsFilters);
